...
?>
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <header class="entry-header">
            ...
            if(empty($image_url)){
                $image_url = get_bloginfo('stylesheet_directory') . "/images/no_image.png";
            }
            ?>
            ...
            <div itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
                <div itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
                    <meta itemprop="url" content="<?php bloginfo('stylesheet_directory'); ?>/images/no_image.png">
    ...
    <div class="entry" itemscope="" itemtype="http://schema.org/Article">
        <div class="col-sm-4">
            <a class="thumbnail" href="<?php the_permalink(); ?>" onclick="_gaq.push(['_trackEvent', 'Xem tin', 'Xem tin', '<?php the_title(); ?>']);">
                <img src="<?php the_post_thumbnail_url('medium'); ?>" alt="<?php the_title(); ?>" itemprop="image" onError="this.src=no_image_src" />
            </a>
        </div>
        <div class="col-sm-8">
