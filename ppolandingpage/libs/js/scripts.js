...
//    $("select.chosen-select").chosen({width: "38%"});
    ...
    if(jQuery("#file").length > 0){
        var hide_cropbox = true;
        jQuery(".cropbox-container .btn-change").click(function (){
            jQuery(".cropped + div").css({
                opacity: 1
            });
            hide_cropbox = false;
        });
        ...
        window.onload = function() {
            ...
            document.querySelector('#btnCrop').addEventListener('click', function(){
                ...
                document.querySelector('#user_avatar').value = img;
                document.querySelector('.imageBox').style = "";
